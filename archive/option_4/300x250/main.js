...
function animate() {
  ...
  tl.to("#bg", {duration: 2, x: -46, y: -61, scale:1.2, ease: "power1.inOut",});
  tl.to("#bg", { scale:1, duration: 2, ease: "power1.inOut",});
  tl.to(".copy", 0.5, { autoAlpha: 1, ease: Power1.easeInOut }, "-=1");
  tl.to("#bg", {y: "-=3", duration: 1.2, ease: "sine.inOut", yoyo: true, repeat: 3,});
}
